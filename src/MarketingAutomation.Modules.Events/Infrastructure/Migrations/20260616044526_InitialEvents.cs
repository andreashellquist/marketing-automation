...
namespace MarketingAutomation.Modules.Events.Infrastructure.Migrations
{
    ...
    public partial class InitialEvents : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_stored_events_IdentifierType_IdentifierValue_OccurredAtTicks",
                schema: "events",
                table: "stored_events",
                columns: new[] { "IdentifierType", "IdentifierValue", "OccurredAtTicks" });

            migrationBuilder.CreateIndex(
                name: "IX_stored_events_Name_OccurredAtTicks",
                schema: "events",
                table: "stored_events",
                columns: new[] { "Name", "OccurredAtTicks" });
